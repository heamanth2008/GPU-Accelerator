"""Browser interface for the LP solver, runnable locally or on Render."""
...
if __name__ == "__main__":
    # Render supplies PORT. Binding to 0.0.0.0 permits its proxy to reach the
    # service; it also works for local development at http://127.0.0.1:8000.
    port = int(os.environ.get("PORT", "8000"))
    server = ThreadingHTTPServer(("0.0.0.0", port), SolverHandler)
    print(f"LP Solver UI running on port {port}")
